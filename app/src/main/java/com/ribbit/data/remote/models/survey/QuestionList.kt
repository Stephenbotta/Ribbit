...
data class Questions( var imageUrl:String?, var quesId:String?,var question: String?,var isImage:Boolean=false,var isVideo:Boolean=false,var optionList:List<Options>?)
