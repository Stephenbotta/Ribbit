...
import com.checkIt.extensions.isSameDay
import com.checkIt.extensions.isSameWeek
import com.checkIt.extensions.isSameYear
import com.checkIt.extensions.isYesterday
...
object DateTimeUtils {
    ...
    fun formatForRecentTime(zonedDateTime: ZonedDateTime?): String {
        return DateUtils.getRelativeTimeSpanString(
                zonedDateTime?.toInstant()?.toEpochMilli() ?: 0L,
                System.currentTimeMillis(),
                DateUtils.SECOND_IN_MILLIS,
                DateUtils.FORMAT_ABBREV_ALL).toString()
    }
